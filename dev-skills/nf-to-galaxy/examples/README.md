...
**Note**: These examples focus on **conversion-specific scenarios**. For detailed instructions on **using Galaxy MCP and BioBlend** to check tools and test workflows, see `../../../skills/galaxy-integration/examples/`.
...
**Setup Galaxy integration**: See `../../../skills/galaxy-integration/galaxy-integration.md` → Setup
